<div>
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Kelola Realisasi APBDes</h2>
            <p class="text-sm text-gray-500">Upload dokumen PDF laporan Realisasi APBDes per tahun.</p>
        </div>
    ...
    <div class="bg-white rounded shadow overflow-x-auto">
        <table class="w-full text-left border-collapse">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="3" class="p-8 text-center text-gray-500">Belum ada dokumen Realisasi APBDes yang diunggah.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
    ...
    @if ($showModal)
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div class="bg-white rounded-lg p-6 w-full max-w-md">
                <h3 class="text-xl font-bold mb-4">{{ $item_id ? 'Edit' : 'Upload' }} Realisasi APBDes</h3>
