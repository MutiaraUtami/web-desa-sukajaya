@php
    ...
    // Siapkan data dengan fallback (nilai bawaan) jika database masih kosong
...
<header class="sticky top-0 left-0 right-0 z-50 shadow-md transition-all duration-300">
    <div class="bg-[#0e2206] text-white text-xs border-b border-[#1e6306]/30">
        <div class="max-w-6xl mx-auto px-4 py-2 flex flex-col sm:flex-row justify-between items-center gap-2">
            ...
            <!-- Bagian Kiri: Email Dinamis -->
            <div class="flex items-center gap-4 flex-wrap justify-center sm:justify-start">
                <a href="mailto:{{ $email }}" class="flex items-center gap-1.5 hover:text-[#fac81b] transition">
            ...
            <!-- Bagian Kanan: Sosial Media Dinamis (WhatsApp & Instagram) -->
            <div class="flex items-center gap-4">
                <a href="https://wa.me/{{ $waLink }}" target="_blank" rel="noopener noreferrer" class="flex items-center gap-1 hover:text-[#fac81b] transition group" title="WhatsApp Desa">
                    <!-- Ikon WhatsApp -->
                    ...
                    <span class="hidden md:inline">{{ $telepon }}</span>
                </a>
